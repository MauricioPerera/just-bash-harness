...
**Version:** 0.1.3 · **Status:** v0 contract complete + packaged + CI'd + polished. 100/100 unit tests pass. End-to-end validated against real Gemma 4 26B on Cloudflare Workers AI. Distributable as a `harness` binary via `npm run build`.
